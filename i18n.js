...
const LANG = {
  ru: {
    setup_title: 'Session Zero',
    setup_subtitle: 'Настройте группу перед началом. Каждый игрок голосует за системы, в которые хочет сыграть — инструмент для вашего цифрового Session Zero.',
    ...
    nav_group_narrative: 'Нарратив и сюрреализм',
    nav_group_tactical: 'Тактика и современность',
    nav_group_borg: '*BORG',
    ...
    'nav_group_post-apocalyptic': 'Постапокалипсис',
    nav_group_noir: 'Нуар',
    'nav_group_sword-and-sorcery': 'Меч и магия',
    nav_group_historical: 'Историческое',
    ...
    results_empty: 'Не выбрано ни одной системы. Откройте «Управление списком», чтобы добавить.',
    ...
    intro_title: 'Не знаете, во что играть?',
    intro_body: 'Session Zero помогает группе выбрать настолку — листайте каталог, голосуйте вместе или поделитесь списком.',
    intro_cta_vote: 'Голосование группой',
    intro_cta_share: 'Поделиться списком',
    export_title: 'Экспорт списка',
    export_header: 'Шортлист Session Zero',
    btn_copy: 'Копировать',
    btn_close: 'Закрыть',
    copied: 'Скопировано!',
    move_up: 'Выше',
    ...
    btn_shared_vote: 'Поделиться списком',
    ...
    toast_local_only: 'Сохранено в этом браузере. Чтобы добавить в общий каталог — нажмите «Предложить в каталог» на странице системы.',
    ...
    tag_sword_sorcery: 'Меч и магия',
    editor_setting_tags: 'Сеттинг',
    tag_filter_playstyle: 'Плейстайл',
    tag_filter_setting: 'Сеттинг',
    tag_filter_rules: 'Правила',
    tag_filter_access: 'Доступ',
    rules_light: 'Лёгкие',
    rules_medium: 'Средние',
    rules_heavy: 'Тяжёлые',
    badge_free: 'Бесплатно',
    tag_filter_cycle_hint: 'Клик: включить → исключить → сбросить',
  ...
  en: {
    setup_title: 'Session Zero',
    setup_subtitle: 'Set up your group before starting. Each player votes for systems they want to try — a digital Session Zero for your table.',
    ...
    'nav_group_post-apocalyptic': 'Post-Apocalyptic',
    nav_group_noir: 'Noir',
    'nav_group_sword-and-sorcery': 'Sword & Sorcery',
    nav_group_historical: 'Historical',
    ...
    results_empty: 'No systems selected. Open “Manage list” to add some.',
    ...
    btn_export: 'Export',
    btn_share: 'Share',
    intro_title: 'Can\'t decide what to play next?',
    intro_body: 'Session Zero helps your group pick a tabletop RPG — browse the catalog, then vote together or share a shortlist.',
    intro_cta_vote: 'Start a group vote',
    intro_cta_share: 'Share a shortlist',
    export_title: 'Export List',
    export_header: 'Session Zero Shortlist',
    btn_copy: 'Copy',
    btn_close: 'Close',
    copied: 'Copied!',
    move_up: 'Move up',
    ...
    btn_shared_vote: 'Share shortlist',
    ...
    toast_local_only: "Saved on this device. Tap 'Suggest for catalog' on the page to share with everyone.",
    ...
    tag_sword_sorcery: 'Sword & Sorcery',
    editor_setting_tags: 'Setting',
    tag_filter_playstyle: 'Playstyle',
    tag_filter_setting: 'Setting',
    tag_filter_rules: 'Rules',
    tag_filter_access: 'Access',
    rules_light: 'Light',
    rules_medium: 'Medium',
    rules_heavy: 'Heavy',
    badge_free: 'Free',
    tag_filter_cycle_hint: 'Click: include → exclude → clear',
